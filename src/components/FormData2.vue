    ...
    <el-dialog
      ...
      <el-form :model="dataForm" :rules="dataRule" ref="dataFormRef" label-width="80px">
        ...
        <el-form-item label="报告时间" prop="reportingtime">
          <el-input v-model="dataForm.reportingtime" placeholder=""></el-input>
        </el-form-item>
        ...
        <el-form-item label="报告者职业" prop="occupation">
          <el-input v-model="dataForm.occupation" placeholder=""></el-input>
        </el-form-item>
        <el-form-item label="报告国家" prop="country">
...
function getDataList() {
  ...
  if (input.key === '') {
    ...
    $http({
      url: `/data/data2/info/${input.key}`,
      method: 'get',
      params: {},
    }).then(({data}) => {
      if (data && data.code === 0 && data.data2 !== null) {
        dataList.value = [data.data2]
      }
      else{
        dataList.value = []
      }
...
function init(id) {
  ...
  if (dataForm.id) {
    $http({
      url: `/data/data2/info/${dataForm.id}`,
      method: 'get',
      params: {},
    }).then(({data}) => {
      if (data && data.code === 0) {
        dataForm.eventid = data.data2.eventid
        dataForm.caseid = data.data2.caseid
        dataForm.date = data.data2.date
        dataForm.reportingtime = data.data2.reportingtime
        dataForm.age = data.data2.age
        dataForm.gender = data.data2.gender
        dataForm.occupation = data.data2.occupation
        dataForm.country = data.data2.country
      }
    })
  }
}
...
function dataFormSubmit() {
  dataFormRef.value.validate((valid) => {
    if (valid) {
      $http({
        url: `/data/data2/${!dataForm.id ? 'save' : 'update'}`,
        method: 'post',
        data: {
          ...
          'date': dataForm.date,
          'reportingtime': dataForm.reportingtime,
          'age': dataForm.age,
